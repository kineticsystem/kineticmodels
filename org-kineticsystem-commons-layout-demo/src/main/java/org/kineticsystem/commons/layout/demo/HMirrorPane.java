...
import org.kineticsystem.commons.layout.DefaultLayoutStrategy;
import org.kineticsystem.commons.layout.TetrisLayout;

/**
 * This is a test dialog showing an horizontal mirror of an existing pane.
 * @author Giovanni Remigi
 * $Revision: 41 $
 */
public class HMirrorPane extends JPanel {
    ...
    public HMirrorPane() {
        ...
        // Change the default layout algorith.
        
        DefaultLayoutStrategy strategy = new DefaultLayoutStrategy();
        strategy.setFlow(DefaultLayoutStrategy.LEFT_RIGHT_BOTTOM_UP_FLOW);
        ...
        button2.setPreferredSize(new Dimension(2 * UNIT, 1 * UNIT));
        JToggleButton button3 = new JToggleButton("C");
        button3.setPreferredSize(new Dimension(2 * UNIT, 2 * UNIT));
        ...
        button6.setPreferredSize(new Dimension(2 * UNIT, 5 * UNIT));
