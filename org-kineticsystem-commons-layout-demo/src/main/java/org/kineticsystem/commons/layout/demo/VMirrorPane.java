...
/**
 * This is a test dialog showing a vertival mirror of an existing pane.
 * @author Giovanni Remigi
 * $Revision: 41 $
 */
public class VMirrorPane extends JPanel {
    ...
    public VMirrorPane() {
        ...
        strategy.setFlow(DefaultLayoutStrategy.RIGHT_LEFT_TOP_DOWN_FLOW);
