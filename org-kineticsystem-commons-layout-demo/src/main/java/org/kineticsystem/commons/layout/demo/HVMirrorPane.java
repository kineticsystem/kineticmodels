...
/**
 * This is a test dialog showing an horizontal and vertical mirror of an
 * existing pane.
 * @author Giovanni Remigi
 * $Revision: 41 $
 */
public class HVMirrorPane extends JPanel {
    ...
    public HVMirrorPane() {
        ...
        strategy.setFlow(DefaultLayoutStrategy.RIGHT_LEFT_BOTTOM_UP_FLOW);
