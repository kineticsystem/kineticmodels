...
public class BeanComboBoxRenderer extends BasicComboBoxRenderer {
    ...
    private static Log logger = LogFactory.getLog(BeanComboBoxRenderer.class);
     ...
     */
    public BeanComboBoxRenderer(String propertyName) {
     ...
     */
    public BeanComboBoxRenderer(String propertyName, Format format) {
        this.propertyName = propertyName;
        this.format = format;
    }
