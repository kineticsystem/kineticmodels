...
/**
 * Action connected to a navigator controller and used to jump to the first
 * element of the controller list model.
 * @author Giovanni Remigi
 * @version $Revision: 36 $
 * @see org.kineticsystem.commons.data.controller.Navigator
 */
public class MoveFirstAction extends AdvancedAction {

    /** Name of the action used to jump to the first element of the list. */
    public static final String ACTION_NAME = "MoveFirstAction";
     ...
     */
    public MoveFirstAction(Navigator controller) {
        this.controller = controller;
        putValue(Action.SMALL_ICON,
            ResourceLoader.getIcon(NAVIGATOR_RESOURCE + "First16.png"));
        putValue(Action.NAME, Localizer.localizeString(NAVIGATOR_BUNDLE,
            "MoveFirstAction"));
        putValue(Action.SHORT_DESCRIPTION, 
            Localizer.localizeString(NAVIGATOR_BUNDLE,
                "MoveFirstAction_Description"));
        setEnabled(false);
    }
