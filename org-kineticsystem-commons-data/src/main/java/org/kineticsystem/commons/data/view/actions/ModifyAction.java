...
/**
 * 
 * Action connected to an editor controller and used to change the selected
 * object.
 * @author Giovanni Remigi
 * @version $Revision: 145 $
 * @see org.kineticsystem.commons.data.controller.DataNavigator
 */
public class ModifyAction extends AdvancedAction {

    /**
     * Name of the action used to change the selected object.
     */
    public static final String ACTION_NAME = "ModifyAction";
     ...
     */
    public ModifyAction(DataNavigator controller) {
        this.controller = controller;
        putValue(Action.SMALL_ICON,
            ResourceLoader.getIcon(NAVIGATOR_RESOURCE + "Edit16.png"));
        putValue(Action.NAME, Localizer.localizeString(NAVIGATOR_BUNDLE,
            "ModifyAction"));
        putValue(Action.SHORT_DESCRIPTION,               
            Localizer.localizeString(NAVIGATOR_BUNDLE, 
                "ModifyAction_Description"));
        setEnabled(false);
    }
