 ...
 * <p>Un'altra particolarità del componente è la capacità di sincronizzare i
...
public class JDataNavigator extends JPanel {
    ...
    public static final String SYNCHRONIZE_ACTION_NAME = SynchronizeAction
        .ACTION_NAME;
    ...
    public static final String MOVE_FIRST_ACTION_NAME = MoveFirstAction
        .ACTION_NAME;
    
    /** Name of the action to move to the next element of the list. */
    public static final String MOVE_BACK_ACTION_NAME = MoveBackAction
        .ACTION_NAME;
    
    /** Name of the action to move to the previous element of the list. */
    public static final String MOVE_FORWARD_ACTION_NAME = MoveForwardAction
        .ACTION_NAME;
    
    /** Name of the action to jump to the last item of the list. */
    public static final String MOVE_LAST_ACTION_NAME = MoveLastAction
        .ACTION_NAME;
    ...
    private void initActions() {
        ...
        moveForwardMouseAction = new MoveForwardMouseAction(dataNavigator
            .getNavigator());
        moveBackMouseAction = new MoveBackMouseAction(dataNavigator
            .getNavigator());
    ...
    private void initComponents() {
        ...
        modifyConfirmButton.setActions(new Action[] {modifyAction,
            confirmAction});
        deleteCancelButton.setActions(new Action[] {deleteAction,
            cancelAction});
    ...
    private void update() {
        ...
        switch(dataNavigator.getState()) {
            ...
            case DataNavigator.DEFAULT_STATE: {
                ...
                moveFirstAction.setEnabled(dataNavigator.getNavigator()
                    .isMoveFirstEnabled());
                moveBackAction.setEnabled(dataNavigator.getNavigator()
                    .isMoveBackEnabled());
                moveForwardAction.setEnabled(dataNavigator.getNavigator()
                    .isMoveForwardEnabled());
                moveLastAction.setEnabled(dataNavigator.getNavigator()
                    .isMoveLastEnabled());
                moveBackMouseAction.setEnabled(dataNavigator.getNavigator()
                    .isMoveBackEnabled());
                moveForwardMouseAction.setEnabled(dataNavigator.getNavigator()
                    .isMoveForwardEnabled());
                break;
            }
