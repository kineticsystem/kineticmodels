...
/**
 * Action connected to an editor controller and used to reload everithing from
 * the database.
 * @author Giovanni Remigi
 * @version $Revision: 145 $
 * @see org.kineticsystem.commons.data.controller.DataNavigator
 */
public class ReloadAction extends AdvancedAction {
    
    /** Name of the action to reload everithing from the database. */
    public static final String ACTION_NAME = "ReloadAction";
     ...
     */
    public ReloadAction(DataNavigator controller) {
        this.controller = controller;
//        putValue(Action.SMALL_ICON,
//            ResourceLoader.getIcon(NAVIGATOR_RESOURCE + "Reload16.gif"));
        putValue(Action.NAME, Localizer.localizeString(NAVIGATOR_BUNDLE,
            "ReloadAction"));
        putValue(Action.SHORT_DESCRIPTION,               
            Localizer.localizeString(NAVIGATOR_BUNDLE,
                "ReloadAction_Description"));
        setEnabled(true);
    }
