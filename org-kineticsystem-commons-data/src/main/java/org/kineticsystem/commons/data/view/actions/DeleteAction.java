...
/**
 * Action connected to an editor controller and used to remove the selected
 * object.
 * 
 * 
 ...
 */
public class DeleteAction extends AdvancedAction {
    
    /**
     * Name of the action used to remove the selected object.
     */
    public static final String ACTION_NAME = "DeleteAction";
     ...
     */
    public DeleteAction(DataNavigator controller) {
        this.controller = controller;
        putValue(Action.SMALL_ICON,
            ResourceLoader.getIcon(NAVIGATOR_RESOURCE + "Delete16.png"));
        putValue(Action.NAME, Localizer.localizeString(NAVIGATOR_BUNDLE,
            "DeleteAction"));
        putValue(Action.SHORT_DESCRIPTION,               
            Localizer.localizeString(NAVIGATOR_BUNDLE,
                "DeleteAction_Description"));
        setEnabled(false);
    }
